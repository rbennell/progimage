...
class TestBuildUrl(TestApi):
    def test_url_with_path(self):
        ...
        self.assertEqual(url, "http://web:5000/a/test/path")

    def test_url_with_path_and_query_args(self):
        url = self.api._build_url("/another/test/path", QUERY_ARGS)
        self.assertEqual(url, "http://web:5000/another/test/path?rotate=90&filter=blur")
    ...
    def test_encoding(self):
        ...
        self.assertEqual(
            url,
            "http://web:5000/image?url=https%3A%2F%2Fpbs.twimg.com%2Fprofile_images%2F3543879283%2F1509e34005183da5ea4eb29150f341e5_400x400.jpeg",
...
class TestGet(TestApi):
    ...
    def test_get(self, get_mock):
        ...
        get_mock.assert_called_with("http://web:5000/image?rotate=90&filter=blur")
...
class TestPost(TestApi):
    ...
    def test_post_without_files(self, post_mock):
        ...
        post_mock.assert_called_with(
            "http://web:5000/image?rotate=90&filter=blur", files=None
        )
    ...
    def test_post_with_files(self, post_mock):
        ...
        post_mock.assert_called_with(
            "http://web:5000/image?rotate=90&filter=blur", files={"file": "buffer"}
        )
...
class TestGetImage(TestApi):
    ...
    def test_get_image_with_id_and_no_effects(self, get_image_mock):
        ...
        get_image_mock.assert_called_with("/image", {"image_id": 1234})
    ...
    def test_get_image_with_url_and_no_effects(self, get_image_mock):
        ...
        get_image_mock.assert_called_with(
            "/image", {"url": "http://images.com/image"}
        )
    ...
    def test_get_image_with_id_and_effects(self, get_image_mock):
        ...
        get_image_mock.assert_called_with(
            "/image", {"image_id": 1234, "rotate": 90, "filter": "blur"}
        )
